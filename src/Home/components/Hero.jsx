    ...
    return(
        ...
        <div className="hero bg-dark" id="hero">
            <div className="bigger-jumbotron d-flex">
                <div className="container-fluid py-5 mb-4 text-white align-items-center">
                    <h1 className="display-4 fw-bold text-primary">Keebara</h1>
                    <h1 className="display-4 fw-bold col-lg-12 mb-3">
